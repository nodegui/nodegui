...
## Hierarchy
  ...
  ↳ [NodeWidget](nodewidget.md)‹[QProgressBarSignals](../interfaces/qprogressbarsignals.md)›
...
* [setNodeParent](qprogressbar.md#setnodeparent)
...
▸ **addEventListener**‹**SignalType**›(`signalType`: SignalType, `callback`: QProgressBarSignals[SignalType]): *void*
...
▸ **removeEventListener**‹**SignalType**›(`signalType`: SignalType, `callback`: QProgressBarSignals[SignalType]): *void*
...
Name | Type |
------ | ------ |
`parentLayout` | [NodeLayout](nodelayout.md)‹[QProgressBarSignals](../interfaces/qprogressbarsignals.md)› |
