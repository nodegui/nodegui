...
▸ **addEventListener**‹**SignalType**›(`signalType`: SignalType, `callback`: QGroupBoxSignals[SignalType]): *void*
...
▸ **removeEventListener**‹**SignalType**›(`signalType`: SignalType, `callback`: QGroupBoxSignals[SignalType]): *void*
