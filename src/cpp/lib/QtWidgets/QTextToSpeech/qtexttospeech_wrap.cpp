...
Napi::Object QTextToSpeechtWrap::init(Napi::Env env, Napi::Object exports) {
  ...
  Napi::Function func =
      DefineClass(env, CLASSNAME,
                ...
                //    InstanceMethod("setRate", &QTextToSpeechtWrap::screenNumber),
                //    InstanceMethod("setPitch", &QTextToSpeechtWrap::screenNumber),
                //    InstanceMethod("volume", &QTextToSpeechtWrap::screenNumber),
