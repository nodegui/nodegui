...
#define SET_YOGA_WIDGET_Q_PROPERTIES \
    ...
    Q_PROPERTY(QString yAlignContent MEMBER _yAlignContent WRITE setYAlignContent) \
    Q_PROPERTY(QString yAlignSelf MEMBER _yAlignSelf WRITE setYAlignSelf) \
    Q_PROPERTY(QString yJustifyContent MEMBER _yJustifyContent WRITE setYJustifyContent) \
    Q_PROPERTY(QString yDirection MEMBER _yDirection WRITE setYDirection) \
    Q_PROPERTY(QString yFlexDirection MEMBER _yFlexDirection WRITE setYFlexDirection) \
    ...
    Q_PROPERTY(QString yPaddingRight MEMBER _yPaddingRight WRITE setYPaddingRight) \
    Q_PROPERTY(QString yPaddingBottom MEMBER _yPaddingBottom WRITE setYPaddingBottom) \
    Q_PROPERTY(QString yPaddingLeft MEMBER _yPaddingLeft WRITE setYPaddingLeft) \
    Q_PROPERTY(QString yPaddingHorizontal MEMBER _yPaddingHorizontal WRITE setYPaddingHorizontal) \
    Q_PROPERTY(QString yPaddingVertical MEMBER _yPaddingVertical WRITE setYPaddingVertical) \
    ...
    Q_PROPERTY(QString yMarginBottom MEMBER _yMarginBottom WRITE setYMarginBottom) \
    Q_PROPERTY(QString yMarginLeft MEMBER _yMarginLeft WRITE setYMarginLeft) \
    Q_PROPERTY(QString yMarginHorizontal MEMBER _yMarginHorizontal WRITE setYMarginHorizontal) \
    Q_PROPERTY(QString yMarginVertical MEMBER _yMarginVertical WRITE setYMarginVertical) \
    ...
    Q_PROPERTY(float yBorderHorizontal MEMBER _yBorderHorizontal WRITE setYBorderHorizontal) \
    Q_PROPERTY(float yBorderVertical MEMBER _yBorderVertical WRITE setYBorderVertical) \
